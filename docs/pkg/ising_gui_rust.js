...
const IsingFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ising_free(ptr >>> 0, 1));
...
export class Ising {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        IsingFinalization.unregister(this);
        return ptr;
    }
     ...
     * @param {number} j
     */
    constructor(n, temp, j) {
        const ret = wasm.ising_new(n, temp, j);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('ising_gui_rust_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
